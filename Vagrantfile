...
Vagrant.configure(2) do |config|
    ...
    config.vm.hostname = "peri.vagrant"
    ...
    config.vm.provision "shell",
      ...
      name: "default dir"
    config.vm.provision "shell", path: "~/Sites/_vagrant-scripts/solr-setup.sh"
    config.vm.provision "file", source: "~/Sites/_vagrant-scripts/aliases", destination: "/home/vagrant/.bash_aliases"
  end
